...
export default function App() {
    ...
    useEffect(() => {
        const initAudio = () => {
            if (audioManager && typeof audioManager.init === 'function') {
                try { audioManager.init(); } catch (e) { console.warn('audioManager.init error', e); }
            }
    ...
    const handleRegistrationComplete = (data) => {
        setPlayerData(data);
        setScreen('GAME');
        if (audioManager && typeof audioManager.playPop === 'function') {
            try { audioManager.playPop(); } catch (e) { console.warn('audioManager.playPop error', e); }
        }
    };
